...
(function(d) {
  d(document).ready(function(a) {
    a("body").vegas({
      slides: [{
        src: "https://i.imgur.com/36GsFBT.jpg"
      }],
      preloadImage: !0,
      overlay: !0
    });
    a("#txt").typist({
      speed: 10
    }).typistPause(2E3).typistAdd(" \u2013 Ch\u00e0o em!\n").typistPause(2E3).typistAdd(" \u2013 Em c\u00f3 mu\u1ed1n khi ch\u1ebft...").typistPause(1500).typistAdd(" s\u1ebd c\u00f3 t\u00ean trong gia ph\u1ea3 nh\u00e0 anh kh\u00f4ng? :x").typistPause(700, function() {
      a("#buttons").fadeIn("fast")
    });
    var c = !1;
    a("#buttons").on("click", "#btn-yes",
      function(a) {
        swal("Tuy\u1ec7t v\u1eddi!", "\u0110\u00f3 l\u00e0 c\u00e2u tr\u1ea3 l\u1eddi m\u00e0 anh mong \u0111\u1ee3i!", "success")
      }).on("click", "#btn-no", function(a) {
      swal("Th\u1eadt ti\u1ebfc!", "D\u00f9 sao th\u00ec anh c\u0169ng t\u00f4n tr\u1ecdng quy\u1ebft \u0111\u1ecbnh c\u1ee7a em.", "error")
    })
    //   .on("mouseenter", function(e) {
    //   c || (c = !0, a(document).mousemove(function(b) {
    //     a("#btn-no").css({
    //       position: "fixed",
    //       top: b.offsetY + 10,
    //       left: b.offsetX + 10
