...
(function (d) {
    d(document).ready(function (b) {
        ...
        CONFIG.content.map(function (a, g) {
            c.typistAdd(a.text);
            g === d ? c.typistPause(a.delay, function () {
                b("#buttons").fadeIn("fast")
            }) : c.typistPause(a.delay)
        });
        var e = !1, f = b("#buttons");
        ...
        CONFIG.alert.troll && (f.on("mouseenter", function (a) {
            e || (e = !0, b(document).mousemove(function (a) {
                b("#btn-no").css({position: "fixed", top: a.offsetY + 10, left: a.offsetX + 10})
            }))
