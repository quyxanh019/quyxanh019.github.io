...
!function (a) {
    ...
    function b(b, c) {
        ...
        }, c || {}), this._cursor = null, this._element = a(b), this._element.data("typist", this), this._container = null, this.queue = [], this.timer = null, this.delay = 1e3 / this.speed, this.blinkTimer = null, this.blinkDelay = 1e3 / this.blinkSpeed, this.text && (this.queue.push({text: this.text}), this.type())
    }

    a.fn.typistInit = function () {
        return this.each(function () {
            a(this).data("typist") || new b(this)
        })
    }, a.fn.typist = function (a) {
        return this.each(function () {
            new b(this, a)
        })
    }, a.fn.typistAdd = function (b, c) {
        ...
        addCursor: function () {
            this._cursor && (clearInterval(this.blinkTimer), this._cursor.stop().remove()), this._cursor = a("<span>|</span>").css(this.cursorStyles).insertAfter(this._container), this.cursorVisible = !0, this.blinkTimer = setInterval(a.proxy(function () {
                this.cursorVisible = !this.cursorVisible, this._cursor.animate({opacity: this.cursorVisible ? 1 : 0}, 100)
            }, this), this.blinkDelay)
        }, fire: function (a) {
            return this._element.trigger(a, this), this
        }, nl2br: function (a) {
            return a.replace(/\n/g, "<br>")
        }, br2nl: function (a) {
            ...
            b--, d = this.br2nl(d), d = d.substr(0, d.length - 1), d = this.nl2br(d), this.timer = setTimeout(a.proxy(function () {
                this._container.html(d), this.remove(b, c)
            }, this), this.delay), this.fire("tick.typist")
        }, step: function (b, c) {
            if ("string" == typeof b && (b = b.split("")), !b.length) return c(), this.timer = null, this.fire("end_type.typist").type();
            var d = b.shift();
            d = a("<div>").text(d).html(), d = this.nl2br(d), this.timer = setTimeout(a.proxy(function () {
                this._container.html(this._container.html() + d), this.step(b, c)
            }, this), this.delay), this.fire("tick.typist")
        }, stop: function () {
            ...
            if (!this.timer) {
                ...
                var b = this.queue.shift() || {}, c = a.proxy(b.callback || a.noop, this);
                return b.delay ? void (this.fire("start_pause.typist").timer = setTimeout(a.proxy(function () {
                    c(), this.timer = null, this.fire("end_pause.typist").type()
                }, this), b.delay)) : b.remove ? void this.fire("start_remove.typist").remove(b.remove, c) : b.stop ? void this.stop() : void (b.text && this.fire("start_type.typist").step(b.text, c))
            }
        }
    }
});
...
/* Fixed by Quyxanh019 */
(function (d) {
    const animateDuration = 160;
    const zIndexBtnNo = 160;
    d(document).ready(function (b) {
        ...
        f.on("click", "#btn-yes", function (a) {
            swal(CONFIG.alert.success.title, CONFIG.alert.success.message, "success").then(okay => {
                if (okay) {
                    window.location.href = "https://quyxanh019.github.io/Love2/show.html";
                }
            })
        });
        !CONFIG.alert.troll && (b("#btn-no").on("click",
            "#btn-no", function (a) {
        ...
        CONFIG.alert.troll && (
            f.on("mouseenter", function () {
                ...
                b("#btn-no").on("touchstart touchmove touchcancel mousedown", function (a) {
                        console.log("touch");
                        //a.preventDefault();
                        b("#btn-no").css({
                            zIndex: zIndexBtnNo,
